...
// Update the import path below to the correct location of CCIPLocalSimulatorFork.sol in your project or dependencies.
...
contract GitCrossChainTest is Test {
    ...
    function setUp() public {
        ...
        sourceRebaseToken.grantBurnAndMintRole(address(sourcePool));
        sourceRebaseToken.grantBurnAndMintRole(address(vault));
        ...
        destRebaseToken.grantBurnAndMintRole(address(destPool));
